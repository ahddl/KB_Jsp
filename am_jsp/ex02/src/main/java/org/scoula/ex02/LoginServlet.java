...
//
//    private DataFlavor req;
//
//    @Override
//    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
//
//        //1. 컨트롤, 전달된 데이터 추출, db처리 기능(DAO호출)
//
//        //userid=apple&passwd=1234, 파라메터
//        // 요청에서 파라미터 얻기
...
//
//        //2. 응답하는 html 생성
//        // 보낼 떄 한글을 utf-8로 인코딩하고 싶으면 설정해야함.
//        //http의 body로 전달되는 데이터는 한글 인코딩을 지정해줘야함
//        resp.setContentType("text/html; charset=UTF-8");
//        PrintWriter out = resp.getWriter(); //html 같은 문자로 이루어진 문서를 만들기 위해, 텍스트로 보낼 문자들을 생성할때 PringWriter 객체 필요
//        // 응답 내보내기
//        out.println("<htmnl>");
//        out.println("<body>");
...
//        //hhtp의 body로 전달됨 --> 한글 인코딩 utf-8로 설정해야함
//         req.setCharacterEncoding("UTF-8");	// 한글 깨짐 방지 - 있을 때와 없을 때 결과 확인!!!
//        //서블릿을 받기 전 한글을 설정하는 부분은 필터를 낄 수 있음 그럼 서블릿에서 생략 가능!
//        // 요청에서 파라미터 얻기
