...
public class TodoController {
    ...
    //해야할일 목록 가지고 오기
    //프론트 컨트롤러가 불러요! 리턴도 프론트컨트롤러에게 view이름을 rutern
    public String getList(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        return "todo/list"; //프론트컨트롤러에게 view이름을 리턴함
        //프론트컨트롤러가 이 view 이름을 이용해서
        // /view/todo/list.jsp 붙여서 호출함 (forward는 프론트컨트롤러가 다함)
    }
